...
model.roi_heads.mask_predictor = FastRCNNPredictor(in_features_mask,
                                                       hidden_layer,
                                                       num_classes)
model.load_state_dict(torch.load("my_fasterrcnn_model.pth.tar")['state_dict'])
model.to(device)
...
optimizer.load_state_dict(torch.load("my_fasterrcnn_model.pth.tar")['optimizer'])
