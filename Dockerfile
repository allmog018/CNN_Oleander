...
RUN apt-get update && apt install -y python-pip sudo 


RUN apt-get install -y software-properties-common sudo
RUN add-apt-repository ppa:deadsnakes/ppa
RUN apt-get update
RUN apt-get install -y python2.7 sudo

RUN apt-get install -y python2.7-dev sudo
...
RUN pip install /home/allmog018/torchvision-0.3.0-cp27-cp27m-manylinux1_x86_64.whl
RUN pip install /home/allmog018/torch-1.1.0-cp27-cp27m-linux_x86_64.whl
